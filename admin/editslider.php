<?php
    ...
    $result = $slider->getSingleSlider($sliderid);
    ...
    if($result->num_rows > 0){
        ...
        <strong>Error ! </strong> Invalid Slider id.
        </div>";
                ...
                <div class="container-fluid">
                    ...
                    <div>
                            ...
                            <div class="my-2">
                                ...
                                <input type="text" id="title" name="title" placeholder="Enter Title for Slider" class="form-control" required autofocus maxlength="64" value="<?php echo $title; ?>">
                            </div>
                            <div class="my-2">
                            ...
                            <img src="<?php echo $imagepath;?>" class="w-100">
                                <div class="my-2">
                                    <input type="submit" value="Update Slider" name="updateProcess" class="btn btn-primary">
...
<?php
    if(isset($_POST["updateProcess"])){
        ...
        $slider->updateSlider($sliderid, $title, $imagepath);
