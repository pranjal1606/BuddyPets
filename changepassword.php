		...
		<div class="container">
			...
			<div class="row">
				...
				<form action="#" method="post">
                    <input type="password" name="cpass" id="cpass" class="form-control my-2" required placeholder="Enter Current Password">
                    <input type="password" name="npass" id="npass" class="form-control my-2" required placeholder="Enter New Password">
                    <input type="password" name="rpass" id="rpass" class="form-control my-2" required placeholder="Re Enter New Password">
...
<?php
    if(isset($_POST["resetprocess"])){
        ...
        if($npass === $rpass){
            ...
            if($users->changePassword($user, $cpass, $npass)){
