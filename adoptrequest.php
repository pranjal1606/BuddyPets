    ...
    <section class="ftco-section bg-light">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            <h2>Previously Generated Requested for Adopt Pet.</h2>
          </div>
        </div>
        ...
        <div class="row">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <?php
                    $result = $users->getPreviousRequests($user);
                    while($row = $result->fetch_assoc()){
                        ...
                        echo "<tr>
                            <td>$row[petname]</td>
                            <td>$row[datetime]</td>
                            <td><a href='adoptprocess.php?adoptid=$row[adoptid]' class='btn btn-primary'>view</a></td>
                            <td>$status</td>
                        </tr>";
                    }
                ?>
